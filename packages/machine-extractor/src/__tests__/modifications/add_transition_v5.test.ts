...
describe('add_transition', () => {
  ...
  it('should be possible to add a non-reentering self-transition to the root (implicit ID)', () => {
    const modifiableMachine = getModifiableMachine(`
      createMachine({})
    `);
  ...
  it('should be possible to add a non-reentering self-transition to the root (explicit ID)', () => {
    const modifiableMachine = getModifiableMachine(`
      createMachine({ id: 'groot' })
	`);
  ...
  it('should be possible to add a non-reentering self-transition to a state', () => {
    const modifiableMachine = getModifiableMachine(`
      createMachine({
        initial: 'foo',
        states: {
  ...
  it('should be possible to add a non-reentering transition with a guard', () => {
    const modifiableMachine = getModifiableMachine(`
      createMachine({
        initial: 'foo',
        states: {
  ...
  it('should be possible to add a reentering transition to a child with a guard', () => {
    const modifiableMachine = getModifiableMachine(`
      createMachine({
        initial: 'foo',
        states: {
